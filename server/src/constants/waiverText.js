/**
 * The liability waiver, transcribed from the centre's paper form.
 *
...
export const WAIVER_SECTIONS = [
  {
    heading: 'DISCLAIMER',
    paragraphs: [
      'The Love Camp Inc (Love Learning Center) is not responsible for any injury (or loss of property) to any person while participating in tutoring, special events, workouts, or in any other way involved in dancing, educational games, Bailey’s Bookworms, social events, private lessons and martial arts at Dael Martial Arts for any reason whatsoever, including ordinary negligence on the part of its members, managers, agents, or employees.',
    ],
  },
  {
    heading: 'CONSENT',
  ...
  },
  {
    heading: 'WAIVER',
    paragraphs: [
      'In consideration for my/minor’s participation in the activity, I hereby waive all claims or causes of action, including ordinary negligence, against The Love Camp, its managers and members, and any of their employees, teachers, coaches, or agents, arising out of my/minor’s participation in the activity wherever, whenever or however the same may occur.',
  ...
  },
  {
    ...
    paragraphs: [
      'I understand the following agreement between myself and The Love Camp (Love Learning Center):',
    ],
    bullets: [
      'There is no guarantee my child’s academic performance will improve. I must follow up on my child’s academic work.',
      'The Love Camp will not be responsible for watching my child outside of scheduled tutoring hours.',
      'I agree to pick up my child at the agreed hour. Failure to do so will disqualify my child from future activities.',
  ...
  },
  {
    ...
    paragraphs: [
      'I give permission for The Love Camp (Love Learning Center) owners, officers, employees, and/or agents to seek emergency medical treatment for the participant(s) in the event they are unable to reach any parent or guardian. The undersigned also agrees that they themselves will be responsible for any financial debt incurred by said action.',
    ],
  },
  {
    heading: 'PHOTO & VIDEO RELEASE',
    paragraphs: [
      'I understand and agree that my/minor’s picture can be taken or be filmed while participating in activities at The Love Camp or when representing The Love Camp at events. I hereby grant to The Love Camp, and its agents, employees and photographers, the right to take, use, publish, and copyright photograph(s) and videos of me/my minor’s in press releases, advertisements, publications, and/or promotions of The Love Camp, including on The Love Camp’s website and on social media websites, such as Facebook, Instagram and YouTube, maintained by The Love Camp and/or its individual employees and/or agents. I hereby release and waive The Love Camp, and its agents, employees, photographers and videographers, from any and all claims or demands arising out of or in connection with said photographs or videos or the publications of said photographs or videos.',
    ],
  },
  {
    heading: 'AGREEMENT',
    paragraphs: [
      'I have read this form and fully understand that by signing this form, I am giving up legal rights and or remedies which may be available to me/minor for the ordinary negligence of The Love Camp (Love Learning Center) or any person listed above. I affirm that I am of legal age and am freely signing this agreement.',
    ],
  },
];
